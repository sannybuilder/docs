...
путь к JSON файлу, сгенерированному в [Sanny Builder Library](../features.md#integration-with-sanny-builder-library), с документацией по скриптовым командам, используемым в целевой [игре](./#game).
