...
Для корректной работы программы требуется INI-файл со [списком опкодов](../edit-modes/opcodes-list-scm.ini.md). В данном поле вы можете указать путь к данному файлу. При нажатии на кнопку появится диалог выбора файла.
